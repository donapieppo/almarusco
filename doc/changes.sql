...
insert into containers values (0, 'clinipack', 60);
insert into containers values (0, 'tanica', 5);
insert into containers values (0, 'tanica', 10);
insert into containers values (0, 'tanica', 20);
insert into containers values (0, 'polietilene', 30);
insert into containers values (0, 'fusto', 30);
insert into containers values (0, 'fusto', 40);
insert into containers values (0, 'polietilene', 60);
insert into containers values (0, 'fusto', 60);
insert into containers values (0, 'tanica', 120);
insert into containers values (0, 'big bag', 500);
