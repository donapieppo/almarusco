class PickingPrint
  ...
  def data_array(data)
    res = [["EER", "Stato fisico", "Descrizione rifiuto", "Tipo di imbal.ggio", "N° e tipo di colli", "Peso (Kg)", "Classi di pericolo", {content: "ADR", width: 30}, "Classe ADR", {content: "ONU", width: 40}, {content: "N. Omologa", width: 50}]]
